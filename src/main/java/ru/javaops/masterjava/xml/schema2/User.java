 ...
 *       &lt;attribute name="involvedProjects">
 *         &lt;simpleType>
 *           &lt;restriction base="{http://javaops.ru}involvedProjectsList">
 *           &lt;/restriction>
 *         &lt;/simpleType>
 *       &lt;/attribute>
 *     &lt;/restriction>
...
public class User {
    ...
    @XmlAttribute(name = "involvedProjects")
    @XmlIDREF
    protected List<Object> involvedProjects;
    ...
    /**
     * Gets the value of the involvedProjects property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the involvedProjects property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getInvolvedProjects().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getInvolvedProjects() {
        if (involvedProjects == null) {
            involvedProjects = new ArrayList<Object>();
        }
