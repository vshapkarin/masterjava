...
public class MailWSClient {
    ...
    public static String sendToGroup(final Set<Addressee> to,
        ...
        String status = WS_CLIENT.getPort().sendToGroup(to, cc, subject, body, attachments, attachmentNames);
    ...
    public static GroupResult sendBulk(final Set<Addressee> to,
        ...
        GroupResult result = WS_CLIENT.getPort().sendBulk(to, subject, body, attachments, attachmentNames);
